...
def evaluate_model(model_path, X_test_path, y_test_path, output_path, model_type):
    ...
    write_evaluation_report(output_path, report, cm, model_type, y_test, predictions, y_score)
...
def write_evaluation_report(file_path, report, confusion_matrix, model_type, y_true, y_pred, y_score):
